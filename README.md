# Zehitomo Design System

A starting point for keeping the Zehitomo design system in sync thanks to the hard work from the people at [Sparkbox](https://sparkbox.com/) who provided this template. Built with Drizzle using Handlebars templates.
